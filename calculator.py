...
class Calculator:
    def __init__(self, master): 
        ...
        # entry_value luu gia tri dau vao
        # equation hien thi gia tri 
        self.equation=StringVar()
        self.entry_value=''
        Entry(width=17, bg='#fff', font=('Arial Bold', 28), textvariable=self.equation).place(x=0,y=0) # setting bang hien thi
        ...
        Button(width=11,height=4,text='DEL',relief='flat',bg='white',command=self.delete_char).place(x=180,y=50)
